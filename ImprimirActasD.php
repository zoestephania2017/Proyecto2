...
$echo=$_POST['idempord'];
$FechaDes=$_POST['textFechaDes'];
$cargo_emp;
$dir_emp;

//consulta
$consulta = mysqli_query($conectar,"SELECT * from detallesordenes where Codigo_Empleado = '$Buscar' && Fecha_DetalleOrden = '$FechaDes' && ID_Orden='Descargo'") or die("Error al extraer los Datos");
...
$consultaCont=mysqli_query($conectar,"SELECT count(*) from detallesordenes where Codigo_Empleado = '$Buscar' && Fecha_DetalleOrden = '$FechaDes' && ID_Orden='Descargo'") or die("Error al extraer los Datos");
...
<head>
 ...
 <body>
  ...
  <h2 style="text-transform: uppercase;">ACTA DE DESCARGO <?php echo $FechaDes;?></h2>
  <form action="validar_descargar.php" method="post">
    <p>Entregue al Departamento de Bienes Nacionales de la Comision Permanente de Contingencias (COPECO), el siguiente equipo que fue asignado para su cuidado y responsabilidad: </p>
   <table>
   ...
   <p >Para constancia firmo la presente acta de descargo, en la aldea El Ocotal, Municipio del Distrito Central, en la presente Fecha.</p>
...
<br>
  ...
  <p style="padding-left: 18%; display: inline;">Entrego Conforme</p>
  <p style="padding-left: 30%; display: inline;">Recibi Conforme</p><br><br><br>-->
