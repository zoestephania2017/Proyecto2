...
//consulta
$consultaCont =  mysqli_query($conectar,"SELECT count(*) from detallesordenes where Codigo_Empleado = '$Buscar' && ID_orden ='Cargo'") or die("Error al extraer los Datos");
$consulta = mysqli_query($conectar,"SELECT * from detallesordenes where Codigo_Empleado = '$Buscar' && ID_orden ='Cargo'") or die("Error al extraer los Datos");
...
<head>
 ...
 <body>
  ...
  <h2 style="text-transform: uppercase;">Inventario al <?php echo $fecha;?></h2>
...
<!--CODIGO REEMPLAZADO POR EL BLOQUE DE ARRIBA -->
